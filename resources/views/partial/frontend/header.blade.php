...
<!--<div class="site-branding container">
    <h1 class="site-logo"><a href="https://lora.az-theme.net/"><img src="https://lora.az-theme.net/wp-content/themes/lora/assets/images/logo.png" alt="L O R A" /></a></h1>
</div>
<nav class="navbar navbar-expand-lg navbar-dark bg-dark static-top">
    <div class="container">
        <a class="navbar-brand" href="#">
            <img src="{{asset('frontend/images/logo/logo.png')}}" width="50px" alt="">
        </a>
        ...
        <div class="col-lg-8 d-none d-lg-block">
            <nav class="mainmenu__nav" >
                <ul class="meninmenu d-flex justify-content-start" >
                    ...
                    <li class="drop with&#45;&#45;one&#45;&#45;item" style="text-decoration: underline; text-decoration-color: 2px 2px 5px #dff0d8;"><a href="{{route('posts.show','our-vision')}}">Our Vision</a></li>
                    <li class="drop" style="text-decoration: underline; text-shadow: 2px 2px 5px #aa0000;"><a href="javascript:void(0)">Categories</a>
                    ...
                    <li style="text-decoration: underline; text-shadow: 2px 2px 5px #aa0000;"><a href="{{route('frontend.contact')}}">Contact</a></li>
                </ul>
            </nav>
        </div>
                                ...
                                <div class="switcher-options">
                                    <div class="switcher-currency-trigger">
                                        <div class="setting__menu">
                                            ...
                                            @else
                                                @if(auth()->user()->ability('admin', 'main'))
                                                    <span><a href="{{ route('admin.index') }}">Admin Panel</a></span>
            ...
            <div class="col-md-4 col-sm-4 col-7 col-lg-2">
                <div class="logo">
                    <a href="{{route('frontend.index')}}">
                        <img src="{{asset('frontend/images/logo/logo.png')}}" width="90" alt="logo images">
                    </a>
                </div>
            </div>
            <div class="col-lg-8 d-none d-lg-block">
...
<!--                    <user-notification></user-notification>-->
                    ...
                    <li style="margin-left: 20px;" class="setting__bar__icon"><a class="setting__active" href="#"></a>
                        <div class="searchbar__content setting__block">
                            <div class="content-inner">
                                <div class="switcher-currency">
                                    <strong class="label switcher-label">
...
<div class="ht__bradcaump__area st" style="background-color: #000000;">
