...
@section('content')
                <div class="col-lg-9 col-12">
                    <div class="blog-details content">
                                            ...
                                            @foreach($post->media as $media)
                                                <div class="carousel-item {{$loop->index == 0 ? 'active': ''}}">
                                                    <img class="d-block w-100"
                                                         src="{{asset('assets/posts/'. $media->file_name)}}"
                                                         alt="{{$post->title}}">
                                                </div>
                                            @endforeach
                                ...
                                <div class="post_header">
                                    ...
                                    <div class="blog-date-categori">
                                        <ul>
                                            ...
                                            <li><a href="{{route('frontend.author.posts',$post->user->username)}}" title="Posts by {{$post->user->name}}"
                        ...
                        @else
                            <p style="text-align: center;">Comments disabled for this post by author.</p>
                        @endif
                    </div>
                </div>
